    ...
    <div className="bg-transparent rounded-xl border border-gray-100 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl w-full">
      ...
      <div className="w-full mx-auto p-2 sm:p-3 bg-purple-50/50 rounded-lg">
        ...
        <div className="flex gap-3 sm:gap-4 justify-center">
          <button className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#1877F2] flex items-center justify-center text-white shadow-sm hover:opacity-90">
            <span className="font-bold text-sm">f</span>
          </button>
          <button className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-black flex items-center justify-center text-white shadow-sm hover:opacity-90">
            <span className="text-base sm:text-lg">𝕏</span>
          </button>
          <button className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#0077B5] flex items-center justify-center text-white shadow-sm hover:opacity-90">
            <span className="text-[10px] sm:text-[11px] font-bold">in</span>
          </button>
          <button className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#25D366] flex items-center justify-center text-white shadow-sm hover:opacity-90">
